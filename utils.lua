...
UTILS.bytesToDouble = function( bytes)
    ...
    mantissa = (mantissa * TWO_TO_EIGHT) + bytes[6]
    mantissa = (mantissa * TWO_TO_EIGHT) + bytes[5]
    mantissa = (mantissa * TWO_TO_EIGHT) + bytes[4]
    mantissa = (mantissa * TWO_TO_EIGHT) + bytes[3]
    mantissa = (mantissa * TWO_TO_EIGHT) + bytes[2]
    mantissa = (mantissa * TWO_TO_EIGHT) + bytes[1]
